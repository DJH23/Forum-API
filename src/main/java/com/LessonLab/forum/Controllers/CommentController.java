...
public class CommentController {
     ...
     * 
     * @PreAuthorize("hasRole('USER') or hasRole('ADMIN') or hasRole('MODERATOR')")
     * public ResponseEntity<?> updateComment(@PathVariable Long id, @RequestBody
     * String newContent) {
     ...
     * 
     * @PreAuthorize("hasRole('USER') or hasRole('ADMIN') or hasRole('MODERATOR')")
     * public ResponseEntity<?> getPagedCommentsByUser(@PathVariable Long userId,
     * Pageable pageable) {
     * Page<Comment> comments = commentService.getPagedCommentsByUser(userId,
     * pageable);
     * return new ResponseEntity<>(comments, HttpStatus.OK);
     * }
     */
     ...
     * public ResponseEntity<?> getCommentsByCreatedAtBetween(@RequestParam
     * LocalDateTime start, @RequestParam LocalDateTime end) {
     * List<Comment> comments = commentService.getCommentsByCreatedAtBetween(start,
     * end);
     * return new ResponseEntity<>(comments, HttpStatus.OK);
     * }
     */
     ...
     * public ResponseEntity<?> getCommentsByContentContaining(@PathVariable String
     * text) {
     ...
     * 
     * @PreAuthorize("hasRole('USER') or hasRole('ADMIN') or hasRole('MODERATOR')")
     * public ResponseEntity<?> countCommentsByPostAndUserNot(@PathVariable Long
     ...
     * 
     * @PreAuthorize("hasRole('USER') or hasRole('ADMIN') or hasRole('MODERATOR')")
     * public ResponseEntity<?> handleCommentVote(@PathVariable Long
